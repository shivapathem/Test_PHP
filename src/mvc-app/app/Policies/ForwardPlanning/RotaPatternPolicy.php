...
class RotaPatternPolicy
{
    use HandlesAuthorization;

    public $userdetails;
    public $isAreaAdmin;
    public $hasEditRotaPattern;

    /**
     * Determine whether the user can view Rota pattern.
     *
     * @param User $user
     * @return bool
     */
    public function view(User $user, ?SchedulingTeam $schedulingTeam = null): bool
    {
        if ($schedulingTeam == null) {
            ...
            if ($user->isSystemAdmin == 1 || $this->isAreaAdmin == 1 || $this->hasEditRotaPattern == 1) {
                return true;
            }
    ...
    /**
     * Determine whether the user can create Rota pattern.
     *
     * @param User $user
    ...
    {
        $this->getUserDetailsByTeam($user, $schedulingTeam);
        if ($user->isSystemAdmin == 1 || $this->isAreaAdmin == 1 || $this->hasEditRotaPattern) {
            return true;
        }
    ...
    /**
     * Determine whether the user can update Rota pattern.
     *
     * @param User $user
    ...
    /**
     * Determine whether the user can delete Rota pattern.
     *
     * @param User $user
     * @param mixed $schedulingTeam scheduling team mdoel instance
     * @return bool
    ...
    private function getUserDetailsByTeam(User $user, SchedulingTeam $team)
    {
        ...
        $this->hasEditRotaPattern = $user->userRoles->where('UR_SchedulingTeamID', $team->schedulingTeamId)->where('RoleName', RefRole::EDIT_ROTA_PATTERNS)->count() > 0 ? 1 : 0;
    }
}
