...
IF NOT EXISTS(SELECT 1 FROM sys.columns 
          ...
          AND Object_ID = Object_ID(N'[dbo].[Allocations]'))
BEGIN
ALTER TABLE [dbo].[Allocations] ADD DutyTeamID INT  DEFAULT 0
END

IF NOT EXISTS(SELECT 1 FROM sys.columns 
          WHERE Name = N'PlannedDuration'
          AND Object_ID = Object_ID(N'[dbo].[Allocations]'))
BEGIN
ALTER TABLE [dbo].[Allocations] ADD PlannedDuration INT  DEFAULT 0
END

IF NOT EXISTS(SELECT 1 FROM sys.columns 
          WHERE Name = N'MarkOverTwelve'
          AND Object_ID = Object_ID(N'[dbo].[Allocations]'))
BEGIN
ALTER TABLE [dbo].[Allocations] ADD MarkOverTwelve SMALLINT  DEFAULT 9
END

IF NOT EXISTS(SELECT 1 FROM sys.columns 
          WHERE Name = N'OverTwelveHrs'
          AND Object_ID = Object_ID(N'[dbo].[Allocations]'))
BEGIN
ALTER TABLE [dbo].[Allocations] ADD OverTwelveHrs INT  DEFAULT 0
END

IF NOT EXISTS(SELECT 1 FROM sys.columns 
          WHERE Name = N'IsOverseasOverTwelve'
          AND Object_ID = Object_ID(N'[dbo].[Allocations]'))
BEGIN
ALTER TABLE [dbo].[Allocations] ADD IsOverseasOverTwelve BIT  DEFAULT 0
END

IF NOT EXISTS(SELECT 1 FROM sys.columns 
          WHERE Name = N'IsUnderElevenBreak'
          AND Object_ID = Object_ID(N'[dbo].[Allocations]'))
BEGIN
ALTER TABLE [dbo].[Allocations] ADD IsUnderElevenBreak BIT  DEFAULT 0
END

IF NOT EXISTS(SELECT 1 FROM sys.columns 
          WHERE Name = N'CalculatedUnderElevenHrs'
          AND Object_ID = Object_ID(N'[dbo].[Allocations]'))
BEGIN
ALTER TABLE [dbo].[Allocations] ADD CalculatedUnderElevenHrs INT  DEFAULT 0
END

IF NOT EXISTS(SELECT 1 FROM sys.columns 
          WHERE Name = N'IsUnderElevenBreakOverride'
          AND Object_ID = Object_ID(N'[dbo].[Allocations]'))
BEGIN
ALTER TABLE [dbo].[Allocations] ADD IsUnderElevenBreakOverride BIT  DEFAULT 0
END

IF NOT EXISTS(SELECT 1 FROM sys.columns 
          WHERE Name = N'OverrideUnderElevenHrs'
          AND Object_ID = Object_ID(N'[dbo].[Allocations]'))
BEGIN
ALTER TABLE [dbo].[Allocations] ADD OverrideUnderElevenHrs INT  DEFAULT 0
END

IF NOT EXISTS(SELECT 1 FROM sys.columns 
          WHERE Name = N'UnderElevenComment'
          AND Object_ID = Object_ID(N'[dbo].[Allocations]'))
BEGIN
ALTER TABLE [dbo].[Allocations] ADD UnderElevenComment NVARCHAR(500)
END

IF NOT EXISTS(SELECT 1 FROM sys.columns 
          WHERE Name IN ('CreatedBy','CreatedDate','UpdatedBy','UpdatedDate')
          AND Object_ID = Object_ID(N'[dbo].[Allocations]'))
BEGIN
	alter table Allocations add  CreatedBy INT,
...
IF NOT EXISTS(SELECT 1 FROM sys.columns 
          WHERE Name IN ('isDutyEditedPostWeek')
          AND Object_ID = Object_ID(N'[dbo].[Allocations]'))
BEGIN
	alter table Allocations add isDutyEditedPostWeek bit not null default 0 
END

IF EXISTS(SELECT 1 FROM sys.columns 
          WHERE Name IN ('isattention')
          AND Object_ID = Object_ID(N'[dbo].[Allocations]'))
BEGIN
