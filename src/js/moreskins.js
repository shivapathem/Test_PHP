CoolClock.config.skins = {
	...
	chunkySwissOnBlack: {
		outerBorder:      { lineWidth: 2, radius: 97, color: "white", alpha: 1 },
		...
		hourHand:         { lineWidth: 4, startAt: -15, endAt: 60, color: "white", alpha: 1 },
		minuteHand:       { lineWidth: 3, startAt: -15, endAt: 85, color: "white", alpha: 1 },
