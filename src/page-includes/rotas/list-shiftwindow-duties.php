...
if(isset($_COOKIE["rotateams"]) && !empty($_COOKIE["rotateams"])){
    $strTeams = $_COOKIE["rotateams"] ?: '0';
}else{
...
$intAreaID = $_SESSION['user']['AreaID'];
$rsDutiesJson = ListAllMasterDuties($intAreaID, $intDutyTypeID, $intArchived, $strTeams);
