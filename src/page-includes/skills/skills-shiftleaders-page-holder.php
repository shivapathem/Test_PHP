...
$arrMyDepartments = GetSkillsDepartmentsShiftLeader($strLogin);  
...
if (isset($arrMyDepartments)) {
  ...
  foreach ($arrMyDepartments as $intDepartmentID => $strDepartmentName) {
    ...
    echo '    <ul>';
    echo '      <li><a href="#skillstabs-0-'.$intDepartmentID.'">Programmes/Staff</a></li>';
    echo '      <li><a href="#skillstabs-1-'.$intDepartmentID.'">Staff/Programmes/Duties</a></li>'; 
    echo '    </ul>';
