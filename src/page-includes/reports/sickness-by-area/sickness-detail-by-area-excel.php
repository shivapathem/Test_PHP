...
$objPHPExcel->getActiveSheet()->setCellValue('G1', 'Date of Sickness');
$objPHPExcel->getActiveSheet()->setCellValue('H1', 'Day of the Week');
$objPHPExcel->getActiveSheet()->setCellValue('I1', 'Name of Sickness');
$objPHPExcel->getActiveSheet()->setCellValue('J1', 'Duration of Sickness');
...
header('Content-Disposition: attachment;filename="SicknessDetailByAreaReport.xlsx"');
