...
<input type="hidden" id="dataSchedulingPerson" value="<?php echo $_REQUEST['data-scheduling-person']?>"/>
<input type="hidden" id="dataRowId" value="<?php echo $_REQUEST['data-row-id']?>"/>
<input type="hidden" id="dataDutyName" value="<?php echo $_REQUEST['data-duty-name']?>"/>
<input type="hidden" id="dataRowStart" value="<?php echo $_REQUEST['data-row-start']?>"/>
<input type="hidden" id="dataRowEnd" value="<?php echo $_REQUEST['data-row-end']?>"/>
<input type="hidden" id="dataUniqueId" value="<?php echo $_REQUEST['data-unique-id']?>"/>
<input type="hidden" id="dataDDate" value="<?php echo $_REQUEST['dutyDate']?>"/>
...
<div class="fields">
	...
	<input type="text" placeholder="dd-mm-yyyy" autocomplete="off"  name="startDate" id="startDateEditWeekly" class="leaveDateSelect" value="<?php echo date('d-M-Y',strtotime($_REQUEST['dutyDate']));?>">
</div>
<div class="fields">
	<label for="endDate">End Date</label>
	<input type="text" placeholder="dd-mm-yyyy" autocomplete="off"  name="endDate" id="endDateEditWeekly" class="leaveDateSelect" value="<?php echo date('d-M-Y',strtotime($_REQUEST['dutyDate']));?>">
</div>
...
<script src="../../../js/edit-weekly-new-leave.js?v=<?php echo time(); ?>"></script>
<script type="text/javascript">
    ...
    $("#endDateEditWeekly").datepicker({
        changeMonth: true,
        changeYear: true,
        dateFormat: "dd-M-yy",
        firstDay: '6',
        minDate:$('#startDateEditWeekly').val(),
        yearRange: "<?php echo $LeaveYear; ?>:<?php echo $LeaveYear + 1; ?>",
        inline: true
    });

    $("#startDateEditWeekly").datepicker({
        changeMonth: true,
        changeYear: true,
        dateFormat: "dd-M-yy",
        firstDay: '6',
        ...
        var sdate = $('#startDateEditWeekly').val();
        $("#endDateEditWeekly").val(sdate);
        if($('#pdlEnable').prop('checked')){
            ...
            if(sdate != ''){
                ...
                $.ajax({
                    ...
                    data:{
                        ...
                        'pdlStartDate': $('#startDateEditWeekly').val(),
                        'pdlEndDate': $("#endDateEditWeekly").val()
                    },
                    success:function(response,status,http) {
            ...
            $("#endDateEditWeekly").datepicker("destroy");
            $("#endDateEditWeekly").datepicker({
                changeMonth: true,
                changeYear: true,
                dateFormat: "dd-M-yy",
    ...
    function checkPDL(){
        if($('#pdlEnable').prop('checked')){
            ...
            $('#newLeaveFormPDLerrorBox').hide();
            $('#newLeaveFormPDLerrorBox').html('');
            $("#endDateEditWeekly").attr("disabled", true);

            if($('#startDateEditWeekly').val() != '' && $('#endDateEditWeekly').val() != ''){
                $('#newLeaveFormPDLerrorBox').hide();
                $('#newLeaveFormPDLerrorBox').html('');
                $.ajax({
                    url:"page-includes/leave/get-allocation-for-leave.php",
            ...
            $('#dutyDetailsNameDiv').hide();
            $('#dutyDetailsTimeDiv').hide();
            $("#endDateEditWeekly").removeAttr("disabled");
            $('#sbt').attr('disabled',false);
            $('#sbt').addClass('activebtn');
            $('#newLeaveFormPDLerrorBox').hide();
            $('#newLeaveFormPDLerrorBox').html('');
            if($('#startDateEditWeekly').val() != ''){
                $("#endDateEditWeekly").datepicker("destroy");
                $("#endDateEditWeekly").datepicker({
                    changeMonth: true,
                    changeYear: true,
